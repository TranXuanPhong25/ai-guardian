...
class ResponseGenerator:
    ...
    def _build_prompt(
        ...
        2. If you can find ANY relevant information in the context, use it to provide a helpful response, even if it's partial.
        3. Focus on what information IS available rather than what's missing.
        4. Only state "I don't have enough information to answer this question based on the provided context." if the context is completely unrelated or empty.
        ...
        10. Even if the information is incomplete, provide what you can find and indicate what additional details might be helpful."""
            
        # Build the prompt
        prompt = f"""You are a helpful document assistant providing accurate information based on the retrieved documents.
        ...
        Extract and present any relevant information from the context that relates to the question, even if it's partial.
        Focus on what information IS available rather than what's missing.
        If you find relevant information, use it to provide a helpful response.
